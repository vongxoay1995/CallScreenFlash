...
public class TextureViewCusTom extends TextureView implements MediaController.MediaPlayerControl {
    ...
    public TextureViewCusTom(Context context) {
        this(context, null);
    }

    public TextureViewCusTom(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TextureViewCusTom(Context context, AttributeSet attrs, int defStyle) {
